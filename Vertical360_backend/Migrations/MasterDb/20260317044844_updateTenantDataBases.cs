...
{
    /// <inheritdoc />
    public partial class updateTenantDataBases : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LinkUsersCompany", x => new { x.UserId, x.CompanyId });
                    table.ForeignKey(
                        name: "FK_LinkUsersCompany_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
